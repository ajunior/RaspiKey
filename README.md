...
* No impact on **input latency**. Measurements of the Apple Wireless Keyboard on RaspiKey showed an input latency of 12 msec, which performs as good as the Apple Magic Keyboard when connected directly through a USB cable (without RaspiKey). For a relative comparison and discussion you can look [here](https://danluu.com/keyboard-latency/).
