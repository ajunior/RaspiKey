...
DBusMessage* g_dbus_send_message_with_reply_blocking(DBusConnection *connection, DBusMessage *message, int timeout, DBusError* 	error)
{
	return dbus_connection_send_with_reply_and_block(connection, message, timeout, error);
}
